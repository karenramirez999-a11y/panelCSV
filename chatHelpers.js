...
function generarFichaHTML(p, numeroGeneral) {
  ...
  return `<div style="max-width:260px;background:rgba(255,255,255,.06);border:1px solid rgba(223,181,80,.3);border-radius:14px;overflow:hidden;margin-top:.4rem;">
    ...
    <div style="padding:.8rem .85rem;">
      ...
      ${descripcionHtml}
      <a href="${linkWhatsAppGeneral(mensajeAgendar, numeroGeneral)}" target="_blank" style="display:block;text-align:center;background:#DFB550;color:#0d1628;font-weight:800;font-size:.76rem;padding:.55rem;border-radius:9px;text-decoration:none;margin-top:.65rem;">📅 Agendar visita</a>
